 ...
 *
 * <ol>
 *   <li>{@link #TYPE_HEADER} — hero image, CTA title, CTA subtitle
 *   <li>{@link #TYPE_FEATURES} — "What you get" card with nested feature rows
 *   <li>{@link #TYPE_PLAN_LABEL} — "Choose your plan" label
 *   <li>{@link #TYPE_PLAN_CARDS} — horizontal or vertical list of plan cards
 *   <li>{@link #TYPE_FOOTER} — Subscribe button, Restore button, cancel note
 * </ol>
 */
public class PaywallAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public int getItemViewType(int position) {
    switch (position) {
      ...
      case 2:
        return TYPE_PLAN_LABEL;
      case 3:
        return TYPE_PLAN_CARDS;
      case 4:
        return TYPE_FOOTER;
      default:
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    switch (viewType) {
      ...
      case TYPE_FEATURES:
        return new FeaturesViewHolder(
            inflater.inflate(R.layout.item_paywall_features, parent, false));
      case TYPE_PLAN_LABEL:
        return new PlanLabelViewHolder(
            inflater.inflate(R.layout.item_paywall_plan_label, parent, false));
      case TYPE_PLAN_CARDS:
        return new PlanCardsViewHolder(
            inflater.inflate(R.layout.item_paywall_plan_cards, parent, false));
      case TYPE_FOOTER:
  ...
  private void bindPlanCards(PlanCardsViewHolder h) {
    ...
    h.planRecycler.setNestedScrollingEnabled(false);
      ...
      PlanCardAdapter planAdapter =
              new PlanCardAdapter(
                      config.getPlans(),
                      selectedPlanIndex, new PlanCardAdapter.OnPlanSelectedListener() {
                  @Override
                  public void onPlanSelected(int index) {
  ...
  private void bindFooter(FooterViewHolder h) {
    ...
    h.subscribeButton.setOnClickListener(
    ...
    h.restoreButton.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View view) {
  ...
  static class PlanLabelViewHolder extends RecyclerView.ViewHolder {
    PlanLabelViewHolder(@NonNull View v) {
      super(v);
    }
  }
